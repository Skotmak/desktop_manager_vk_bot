...
"font: 75 14pt \"MS Shell Dlg 2\";")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 10, 761, 591))
        self.tableWidget.setMinimumSize(QtCore.QSize(761, 0))
...
"запись"))
        ...
        item.setText(_translate("MainWindow2", "Кочетков"))
        item = self.tableWidget.item(0, 1)
        item.setText(_translate("MainWindow2", "Максим"))
        item = self.tableWidget.item(0, 2)
        item.setText(_translate("MainWindow2", "Владимирович"))
        item = self.tableWidget.item(0, 3)
        item.setText(_translate("MainWindow2", "58261561651"))
