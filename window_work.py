...
"запись"))
        ...
        self.stud_tab.headerItem().setText(0, _translate("MainWindow2", "Фамилия"))
        self.stud_tab.headerItem().setText(1, _translate("MainWindow2", "Имя"))
        self.stud_tab.headerItem().setText(2, _translate("MainWindow2", "Отчество"))
        self.stud_tab.headerItem().setText(3, _translate("MainWindow2", "Номер студенческого"))
