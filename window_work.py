...
"font: 75 14pt \"MS Shell Dlg 2\";")
        ...
        self.treeWidget_2.setGeometry(QtCore.QRect(0, 30, 651, 241))
        self.treeWidget_2.setObjectName("treeWidget_2")
        self.tabWidget.addTab(self.tab_2, "")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.treeWidget = QtWidgets.QTreeWidget(self.tab)
        self.treeWidget.setGeometry(QtCore.QRect(0, 0, 611, 611))
...
"запись"))
        ...
        self.treeWidget_2.headerItem().setText(0, _translate("MainWindow2", "Дата события"))
        self.treeWidget_2.headerItem().setText(1, _translate("MainWindow2", "Текст события"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow2", "Временные изменения"))
        self.treeWidget.headerItem().setText(0, _translate("MainWindow2", "Фамилия"))
        self.treeWidget.headerItem().setText(1, _translate("MainWindow2", "Имя"))
        self.treeWidget.headerItem().setText(2, _translate("MainWindow2", "Отчество"))
        self.treeWidget.headerItem().setText(3, _translate("MainWindow2", "Номер студенческого"))
