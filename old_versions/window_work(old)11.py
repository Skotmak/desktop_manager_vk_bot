...
"font: 75 14pt \"MS Shell Dlg 2\";")
        ...
        item = QtWidgets.QTableWidgetItem()
        self.TW_temp.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.TW_temp.setItem(0, 1, item)
...
"запись"))
        ...
        __sortingEnabled = self.TW_temp.isSortingEnabled()
        self.TW_temp.setSortingEnabled(False)
        item = self.TW_temp.item(0, 0)
        item.setText(_translate("MainWindow2", "test_data"))
        item = self.TW_temp.item(0, 1)
        item.setText(_translate("MainWindow2", "test_text"))
        self.TW_temp.setSortingEnabled(__sortingEnabled)
