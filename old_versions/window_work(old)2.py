...
class Ui_MainWindow2(object):
    def setupUi(self, MainWindow2):
        ...
        self.plain_te = QtWidgets.QPlainTextEdit(self.gridLayoutWidget)
        self.plain_te.setObjectName("plain_te")
        self.gridLayout.addWidget(self.plain_te, 0, 1, 1, 1)
        self.list_W = QtWidgets.QListWidget(self.gridLayoutWidget)
        ...
        item = QtWidgets.QListWidgetItem()
        self.list_W.addItem(item)
        self.gridLayout.addWidget(self.list_W, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow2):
        ...
        __sortingEnabled = self.list_W.isSortingEnabled()
        self.list_W.setSortingEnabled(False)
        item = self.list_W.item(0)
        item.setText(_translate("MainWindow2", "Понедельник"))
        item = self.list_W.item(1)
        item.setText(_translate("MainWindow2", "Вторник"))
        item = self.list_W.item(2)
        item.setText(_translate("MainWindow2", "Среда"))
        item = self.list_W.item(3)
        item.setText(_translate("MainWindow2", "Четверг"))
        item = self.list_W.item(4)
        item.setText(_translate("MainWindow2", "Пятница"))
        item = self.list_W.item(5)
        item.setText(_translate("MainWindow2", "Суббота"))
        self.list_W.setSortingEnabled(__sortingEnabled)
